...
weather_converted = list(map(lambda data: {"city": data["city"], "temp_celsius": data['temp_celsius']}, weather_data ))
weather_converted = list(map(lambda data: {"city": data["city"], "temp_fahrenheit": data['temp_celsius']*9/5+32}, weather_data ))
weather_converted = list(map(lambda data: {"city": data["city"], "temp_kelvin": data['temp_celsius']+273.15}, weather_data ))
